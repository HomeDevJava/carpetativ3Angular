...
export class EmpleadosComponent implements OnInit {
  ...
  openDialog( entidad: Empleado ) {
    if ( entidad == null ) {
      this.dialogRef = this.dialog.open( FormempleadosComponent, { height: '90%', width: '30%' } );
    } else {
      this.dialogRef = this.dialog.open( FormempleadosComponent, { data: entidad, height: '90%', width: '30%' } );
    }
